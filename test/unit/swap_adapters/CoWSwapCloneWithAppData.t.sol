...
contract CoWSwapCloneWithAppDataTest is Test, Constants {
    using GPv2Order for GPv2Order.Data;

    CoWSwapCloneWithAppData private impl;
        ...
        public
    {
        ...
        vm.expectRevert();
        CoWSwapCloneWithAppData(clone).initialize();
    }
        ...
        public
    {
        ...
        vm.expectEmit();
        emit CoWSwapCloneWithAppData.CoWSwapCloneCreated(
        ...
        public
    {
        ...
        assertEq(
            CoWSwapCloneWithAppData(clone).isValidSignature(orderDigest, abi.encode(order)),
        ...
        public
    {
        ...
        assertEq(
            CoWSwapCloneWithAppData(clone).isValidSignature(badOrderDigest, abi.encode(order)),
        ...
        public
    {
        ...
        assertEq(
            CoWSwapCloneWithAppData(clone).isValidSignature(
        ...
        public
    {
        ...
        vm.expectEmit();
        emit CoWSwapCloneWithAppData.OrderClaimed(operator, initialSellBalance, initialBuyBalance);

        // Claim the tokens
        vm.prank(operator);
        (uint256 claimedSellAmount, uint256 claimedBuyAmount) = CoWSwapCloneWithAppData(clone).claim();
        ...
        public
    {
        ...
        vm.expectRevert(CoWSwapCloneWithAppData.CallerIsNotOperatorOrReceiver.selector);
        vm.prank(caller);
        CoWSwapCloneWithAppData(clone).claim();
    }
