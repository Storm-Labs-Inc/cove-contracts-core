...
/// @title Staging_RedeployCoWSwapAdapterAppData
/// @notice Re-deploys the CoWSwap adapter with the updated appData requirements and wires it into the staging
/// BasketManager.
contract StagingRedeployCoWSwapAdapterAppData is DeployScript, Constants, BuildDeploymentJsonNames {
